...
public class test {
    ...
    public static final DeferredItem<Boo> BOO_ITEM = ITEMS.registerItem("boo", 
            Boo::new, new Item.Properties());
    public static final DeferredItem<Infinity> INFINITY_ITEM = ITEMS.registerItem("infinity", 
            Infinity::new, new Item.Properties());
    public static final DeferredItem<breaker> BREAKER_ITEM = ITEMS.registerItem("breaker", 
            breaker::new, new Item.Properties());
    public static final DeferredItem<staff> END_ITEM = ITEMS.registerItem("staff", 
            staff::new, new Item.Properties());
    
    public static final DeferredItem<LightningMace> LIGHTNING_MACE_ITEM = ITEMS.registerItem("lightning_mace", 
            properties -> new LightningMace(properties
                    .attributes(LightningMace.createAttributes())
                    .component(net.minecraft.core.component.DataComponents.TOOL, LightningMace.createToolProperties())
            )
    );
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.test")) //The language key for the title of your CreativeModeTab
